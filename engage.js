...
W.spinSlot=function(){
  ...
  btn.disabled=true;
  var emojis=['🌙','🍶','🎵','🔥','💎','🎋','🏮','✨'];
  var prizes=['일산룸 총책임자 VIP 안내','분위기 최고 자리 배정','가야금 라이브 리퀘스트','웰컴 음료 서비스','사진 촬영 스팟 안내'];
...
(function(){
  ...
  ex.innerHTML='<div class="exit-popup" style="position:relative"><button class="exit-close" onclick="closeExit()">&times;</button><h3>잠깐! 이것만 보고 가세요</h3><p>아직 못 본 비밀 콘텐츠가 남아있어요.<br>80% 스크롤하면 숨겨진 이야기가 열립니다.</p><a class="exit-cta" href="tel:010-4117-5556" target="_blank" rel="noopener noreferrer">일산룸 총책임자에게 바로 전화</a></div>';
