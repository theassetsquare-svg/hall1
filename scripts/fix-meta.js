...
const metas = {
  'index.html': {
    ...
    desc: '형이 전화했다. "야, 금요일 저녁에 시간 돼?" 그게 시작이었다. 문 열고 들어간 순간 가야금 소리에 심장이 멈췄다. 예약부터 코스, 주차까지 전부 정리했다. 일산룸 총책임자 안내.',
  },
  'reservation/index.html': {
    title: '일산명월관요정 예약 — 손이 떨렸다, 근데 전화 한 통이면 끝이었다',
    desc: '뭐라고 말해야 하지? 격식 차려야 하나? 쓸데없는 걱정이었다. 일산룸 총책임자 목소리가 편했다. 동네 형 같았다. 언제 전화하고, 뭘 말하면 되는지 전부 적었다.',
  },
  'course/index.html': {
