...
const pages = [
  { file: 'index.html', nextUrl: '/reservation/', nextTitle: '예약 방법 알아보기', gateText: '단골들만 아는 비밀이 있다. 일산룸 총책임자은 두 번째 방문부터 취향을 기억한다. 지난번에 좋아했던 안주, 앉았던 자리, 선호하는 술까지. 기계가 아니라 사람이 하는 서비스. 그래서 한 번 오면 안 올 수가 없다.' },
  { file: 'reservation/index.html', nextUrl: '/course/', nextTitle: '코스 요리 미리 보기', gateText: '예약할 때 "처음입니다"라고 말하면 대우가 달라진다. 일산룸 총책임자이 메뉴부터 자리, 공연 시간까지 직접 맞춰준다. 단골이 되는 첫걸음은 솔직함이다.' },
